...
class MarketSimulatorTest {
    ...
    fun `prices never go below 0_01`() {
        ...
        for (seed in 1..50) {
            simulator = MarketSimulator(stockRepo, Random(seed))
            simulator.simulateStep()
        }
        val stock = stockRepo.findAll().first()
    ...
    fun `multiple steps keep prices valid`() {
        ...
        simulator = MarketSimulator(stockRepo, Random(123))
